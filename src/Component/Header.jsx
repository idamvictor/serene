...
const Header = ({ onBack, headerStyling }) => {
  return (
    ...
    <header className={`serene-header fixed top-0 right-0 left-0  border-b-[0.1rem] border-[#575757] bg-serene-black h-[3.75rem] z-[900] text-serene-ash  lg:left-[12.625rem] xl:left-[15.625rem] flex items-center px-4 lg:px-7 py-10 ${onBack ? "lg:justify-between"  : "lg:justify-end" } ${headerStyling}`}>
      {onBack && (
