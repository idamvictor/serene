  ...
  return (
    <div className="text-white border border-[#272727] rounded w-full h-full p-10">
      ...
      <div className="flex mx-10 mt-5">
        ...
        <button className="bg-[#272727] px-10 font-bold rounded py-2">
          cem-jnmt-hsu
        </button>
      </div>
      ...
      <div className="flex justify-between mt-5">
        <button className="bg-serene px-10 rounded py-2 text-[#272727] font-medium">
          Reschedule
        </button>
        <button className="border-2 rounded text-serene font-medium border-serene px-10 py-2">
          Cancel
        </button>
      </div>
    </div>
