...
const TherapistLanding = ({ animation, therapistImg }) => {
  return (
    <>
      ...
      <div className="">
        <article {...animation}  
          className="bg-[#3e3e3e] border-[2px] lg:border-[.1875rem] border-[#565656] lg:w-[26.26rem] h-[29.18rem] rounded-2xl text-white text-opacity-90 flex flex-col items-center justify-center gap-3 relative min-w-[18.75rem] lg:min-w-0 ">
