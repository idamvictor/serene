    ...
    return (
        <article className="border-b-[.05rem] border-b-[#505050] flex flex-col md:items-center md:flex-row gap-4 mt-5 pb-5">
            ...
            <div className="article-info md:pr-32 flex flex-col gap-2">
                ...
                <p className="text-serene-gray font-medium text-[.82rem] md:text-sm leading-6 xl:text-base">
                    {articleDescription}
                </p>
                <button
                    className="border border-1 border-serene rounded-sm text-serene font-medium text-xs flex items-center px-2 py-1 w-[6.5rem] xl:w-[7rem] mt-1 xl:text-sm"
                    onClick={onClick}
                >
                    Read more
