...
const ArticleContent = () => {
  return (
    <>
        <article className="mb-8 w-4/5">
            <img src={articleContentPic} alt="" className="w-[948px] h-[438px] " />


            <header>
                <h1 className="text-white text-5xl font-medium leading-[1.1] mt-5 ">Discover how yoga can improve physical and mental health for women of all ages across Africa</h1>

                <div className="article-meta text-[#d9d9d9] flex items-center justify-between mt-5 tracking-wide ">
                ...
                <div className="article-highlights flex items-center text-[#afb8be] font-bold justify-between mt-5 ">
            ...
            <main className="text-[#d9d9d9] mt-7 ">
                ...
                <section className="flex flex-col gap-3  text-lg leading-8 tracking-[.25px] mb-8 ">
                    <h2 className="text-[#fefefe] text-2xl font-semibold ">Major Topics</h2>
                ...
                {/* SUB-SECTION 1 */}
                <section className="flex flex-col gap-3  text-lg leading-8 tracking-[.25px] mb-8 ">
                    <h2 className="text-[#fefefe] text-2xl font-semibold ">Sub Topics</h2>
