        ...
        <>
         <section className="row-span-2">
           ...
           <section className="row-start-2 row-end-3 lg:col-span-1 xl:mt-[-.8rem]">
            ...
            <p className="text-white text-opacity-80 text-sm mt-3">Jeffrey Lieberman explores the stigma surrounding mental illness, emphasizing how society's negative perceptions have shaped the mental health landscape. He discusses the need for open conversations and understanding to combat these stigmas.
           </p>
          </section>
         </>
       )}
