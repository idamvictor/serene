...
const SmallArticleCard = ({ articlePreviewImg, articleTag, articleTitle, articleAuthor, onClick }) => {
  return (
    <>
      <article 
        className="smallVideo-card-cont flex items-center gap-1 mt-3 cursor-pointer" 
        onClick={onClick}
      >
