...
const VideoCard = ({
  ...
  return (
    <>
      <div onClick={() => onClick(videoUrl)} className="videoCard-cont border border-[#101010] bg-[#101010] rounded-md pb-2  ">
...
//     <>
//       <div
//         className="videoCard-cont border border-[#101010] bg-[#101010] rounded-md pb-2 cursor-pointer"
//         onClick={() => onClick(videoUrl)} // Call onClick with videoUrl
//       >
//         <div className="flex flex-col items-end justify-end">
//           <ReactPlayer
//             url={videoUrl}
