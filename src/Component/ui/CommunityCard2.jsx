      ...
      <div className="border border-[#333333] bg-[#1b1b1b] rounded-[.5625rem] flex items-start gap-2 p-3 relative h-[10.5rem] ">
          ...
          <div className="flex flex-col gap-2 w-[100%]">
            <div className="flex items-center justify-between">
              ...
              <LuMoreVertical className="text-[#c7c7c7] size-5 absolute flex right-1" />
            </div>
            ...
            <div className="community-members flex items-center justify-between lg:w-[82%] xl:w-[86.5%] absolute bottom-0 mb-3 ">
