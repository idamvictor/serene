    ...
    return ( 
        <article className="border-b-[.05rem] border-b-[#505050] flex items-center gap-4 mt-5 pb-5">
            ...
            <div className="article-info pr-32 flex flex-col gap-2">
                <h4 className="font-semibold text-white text-base xl:text-lg ">{articleTitle}</h4>
                <p className="text-serene-gray font-medium text-sm leading-6 xl:text-base ">{articleDescription}</p>
                <button className="border border-1 border-serene rounded-sm text-serene font-medium text-xs flex items-center px-2 py-1 w-[7rem] mt-1 xl:text-sm ">
                    Read more 
