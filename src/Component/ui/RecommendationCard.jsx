    ...
    return ( 
        <>
            <div className="recommendation-cont md:bg-[#272727] md:flex md:flex-col md:p-8 md:h-[auto] rounded-[.73rem] ">
                ...
                <main className="md:mt-5 md:grid md:grid-cols-[1fr_1fr] md:auto-rows-auto md:place-items-center md:place-content-center md:gap-[.6rem] flex flex-row items-center mt-2">{children}</main>
            </div>
        </>
     );
}
