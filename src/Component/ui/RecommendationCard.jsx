const RecommendationCard = ({img, imgCaption, recommendedText, children}) => {
    return ( 
        <>
            <div className="recommendation-cont rounded-[.73rem] md:bg-[#272727] md:flex md:flex-col md:p-4 md:h-[auto]  lg:p-8 ">
                ...
                <main className="lg:mt-5 lg:grid lg:grid-cols-[1fr_1fr] lg:auto-rows-auto lg:place-items-center lg:place-content-center lg:gap-[.6rem] flex flex-row items-center mt-2">{children}</main>
            </div>
        </>
     );
}
