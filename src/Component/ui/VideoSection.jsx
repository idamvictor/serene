...
const VideoSection = () => {
  ...
  return (
    <>
    <section className={`mt-4 mb-4 grid grid-cols-[2fr_1fr] auto-rows-auto lg:gap-5 xl:gap-7 ${!isPlaying ?' text-serene ': 'text-white'}p`}>

            {/* VIDEO PLAYER SECTION */}
        <div  className='rounded-[11px] overflow-hidden border border-[#666666] col-span-1 row-span-1'>
            <ReactPlayer
        ...
        {!isPlaying && (
            <>
                ...
                <section className="col-span-1 ">
                    <h2 className='  text-white text-xl text-opacity-80 font-bold '>Recommended</h2>
                    <div >
                       <SmallVideoCard 
                ...
                {/* MORE VIDEOS SECTION */}
                <section className="more-videos-section col-span-2">
        ...
        {isPlaying && (
            ...
            {/* VIDEO DESCRIPTION SECTION */}
                <section className='col-span-1 mt-[-.8rem] '>
                    <div className='flex justify-between '>  
                        ...
                        <div className='flex gap-7 items-center '>
                            <button className='text-serene text-sm flex items-center gap-1 border border-serene font-medium rounded-[4px] py-2 px-3 '>
                                <img src={yellowShareIcon} alt="" />
                                Share
                            </button>
                            <button className='text-[#0b0b0b] text-sm bg-serene flex items-center gap-1 border border-serene font-medium rounded-[4px] py-2 px-3  '>
                                <img src={saveAddIcon} alt="" />
                                Save
                            </button>
                        </div>
                    </div>
                    <h5 className='text-white text-xl font-medium mt-5 leading-[27px] '>Robert Waldinger: What makes a good life? Lessons from the longest study on happiness | TED</h5>  
                    <p className='text-white text-sm mt-5 tracking-wide leading-[26px] '>What keeps us happy and healthy as we go through life? If you think it's fame and money, you're not alone – but, according to psychiatrist Robert Waldinger, you're mistaken. As the director of 75-year-old study on adult development, Waldinger has unprecedented access to data on true happiness and satisfaction. In this talk, he shares three important lessons learned from the study as well as some practical, old-as-the-hills wisdom on how to build a fulfilling, long life.</p>
                </section>
            </>
        )}
