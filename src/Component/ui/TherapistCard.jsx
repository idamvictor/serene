...
const TherapistCard = () => {
    return ( 
        <>
            <div className="therapistCard-cont border-[1px] rounded-xl border-[#747474] w-[12.5rem] p-4">
                <div className="therapistCard-profile flex gap-3">
                    ...
                    <div className="therapistCard-info">
                        <p className="text-white font-semibold text-[.8rem] ">Dike Odogwu</p>
                        <p className="text-serene-gray text-[.7rem] font-medium my-1">Family Therapist</p>
                        <div className="therapistCard-rating flex items-center gap-1">
                            <img src={star} alt="" />
                            <span className="text-[#7B7B7B] text-[.65rem] font-[500]">4.92</span>
                        </div>
                    </div>
                </div>
