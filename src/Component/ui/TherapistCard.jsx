...
const TherapistCard = () => {
    return ( 
        <>
            <div className="therapistCard-cont border-[1px] rounded-xl border-[#747474] p-4 mr-4 pr-20 lg:pr-0 lg:mr-0 lg:h-44 lg:max-w-full xl:w-[14.6rem] ">
                <div className="therapistCard-profile flex gap-3">
                    ...
                    <div className="therapistCard-info">
                        <p className="text-white font-semibold text-[.8rem] xl:text-base w-32">Dike Odogwu</p>
