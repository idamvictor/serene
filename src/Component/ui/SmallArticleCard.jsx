import { smallArticleCardPic } from "@/assets";
    ...
    <>
        <article className="smallVideo-card-cont flex items-center gap-1 mt-3 ">
            <div className="w-[119px] overflow-hidden rounded-[3px] flex flex-col items-end justify-end ">
                <img src={smallArticleCardPic} alt="" className="size-full relative" />
            </div>

            <div className="">
                <Badges styling={`bg-serene-gray px-[7.32px] py-[3.05px] mb-1 `}>Family issues</Badges>
                ...
                <p className="text-[#c7c7c7] text-[11px] text-xs mt-1 ">By Sanjana Gupta</p>
