...
const CommunityCard = ({backgroundColor, BadgeStyling, communityName, communityMembers, communityPicture}) => {
    ...
    return ( 
        <>
            <div className={` ${backgroundColor} communityCard1-cont rounded-lg flex items-center gap-2 mr-4 pr-28 pl-2 w-[13rem] md:px-2 md:py-4 lg:mr-0 lg:gap-1 lg:h-[5.5rem] lg:max-w-full xl:justify-start xl:gap-6 xl:w-[15rem] xl:py-8`}>
