          ...
          <section className="flex flex-col mt-10 w-full">
            ...
            <section className="flex flex-col px-5 pt-5 pb-8 mt-6 bg-zinc-800 border border-neutral-500 min-h-[13.75rem]">
              ...
              <div className="flex flex-col mt-6 gap-2">
                <button className="flex items-center justify-center gap-1 px-5 py-3 bg-serene rounded-lg text-neutral-950">
                  <img
                    loading="lazy"
                ...
                <button className="flex items-center justify-center gap-1 px-5 py-3 border border-serene rounded-lg text-serene bg-transparent">
